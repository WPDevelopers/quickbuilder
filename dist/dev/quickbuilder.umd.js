(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@wordpress/data'), require('lodash-es'), require('@wordpress/api-fetch'), require('@wordpress/date'), require('moment'), require('lodash'), require('@wordpress/components'), require('react-draft-wysiwyg'), require('draft-js'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', '@wordpress/data', 'lodash-es', '@wordpress/api-fetch', '@wordpress/date', 'moment', 'lodash', '@wordpress/components', 'react-draft-wysiwyg', 'draft-js', 'react-dom'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.quickbuilder = {}, global.React, global.wpData, global.lodashEs, global.wpApiFetch, global.wpDate, global.momentLib, global.lodash, global.wpComponents, global.reactDraftWysiwyg, global.draftJs, global.ReactDOM));
})(this, (function (exports, React, data, lodashEs, apiFetch, date, moment, lodash, components$1, reactDraftWysiwyg, require$$1, reactDom) { 'use strict';
	...
	*/
	...
	var wpFetch = function wpFetch(params) {
	  var args = _objectSpread$a(_objectSpread$a({}, params), {}, {
	    method: "POST"
	  });
	    ...
	    if (!isEmptyObj(selectedData)) {
	      ...
	      if (_typeof(newData) != "function") {
	        if (isArray(checkAgainst) && isArray(newData)) {
	          ...
	          return (_intersect = intersect_1(newData, checkAgainst)) === null || _intersect === void 0 ? void 0 : _intersect.length;
	  ...
	  reducer: function reducer() {
	    ...
	    switch (action.type) {
	      case "SET_SAVED_VALUES":
	        {
	          var _updatedState = _objectSpread$9({}, state);

	          _updatedState = _objectSpread$9(_objectSpread$9({}, _updatedState), {}, {
	      ...
	      case "FIELD_VALUE":
	        {
	          ...
	          var _updatedState2 = _objectSpread$9({}, state);

	          var payload = action.payload;
	              action.name;
	          _updatedState2 = _objectSpread$9(_objectSpread$9({}, _updatedState2), {}, {
	            values: _objectSpread$9(_objectSpread$9({}, (_updatedState3 = _updatedState2) === null || _updatedState3 === void 0 ? void 0 : _updatedState3.values), payload)
	          });
	      ...
	      case "REMOVE_FIELD_VALUE":
	        {
	          ...
	          var _updatedState4 = _objectSpread$9({}, state);
	      ...
	      case "RESET_FIELD_VALUE":
	        {
	          ...
	          var _updatedState5 = _objectSpread$9({}, state);
	      ...
	      case "FIELD_ERROR":
	        return _objectSpread$9(_objectSpread$9({}, state), {}, {
	          errors: _objectSpread$9(_objectSpread$9({}, state.errors), action.payload)
	        });

	      case "REMOVE_FIELD_ERROR":
	        var updatedState = _objectSpread$9({}, state);
	      ...
	      case "FIELD_TOUCHED":
	        return _objectSpread$9(_objectSpread$9({}, state), {}, {
	          touched: _objectSpread$9(_objectSpread$9({}, state.touched), action.payload)
	        });
	    }
	...
	var Menu$1 = function Menu(props) {
	  ...
	  var componentClasses = classNames$1("wprf-tab-menu-wrapper", props === null || props === void 0 ? void 0 : props.className, {
	  ...
	  return React.createElement("div", {
	    ...
	    return React.createElement("li", {
	      className: classNames$1("wprf-tab-nav-item", (_classNames = {}, _defineProperty$1(_classNames, "".concat(tab.classes), tab.classes), _defineProperty$1(_classNames, "wprf-active-nav", active === tab.id), _defineProperty$1(_classNames, "wprf-tab-complete", config !== null && config !== void 0 && config.completionTrack ? index <= currentTabIndex : false), _classNames)),
	      "data-key": tab.id,
	      key: tab.id,
	...
	*/
	...
	var SweetAlert$2 = function SweetAlert() {
	  ...
	  return Swal.fire(_objectSpread$8({
	  ...
	  switch (action.type) {
	    ...
	    case 'SET_ACTIVE_TAB':
	      return _objectSpread$7(_objectSpread$7({}, state), {}, {
	        config: _objectSpread$7(_objectSpread$7({}, state.config), {}, {
	    ...
	    case 'SET_REDIRECT':
	      return _objectSpread$7(_objectSpread$7({}, state), {}, {
	        redirect: _objectSpread$7(_objectSpread$7({}, state.redirect), action.payload)
	      });
	    ...
	    case 'SET_FIELD_TOUCHED':
	      return _objectSpread$7(_objectSpread$7({}, state), {}, {
	        touched: _objectSpread$7(_objectSpread$7({}, state.touched), {}, _defineProperty$1({}, action.payload.field, action.payload.value))
	      });
	...
	var useBuilder = function useBuilder(props) {
	  ...
	  var _useReducer = React.useReducer(builderReducer, _objectSpread$6(_objectSpread$6({}, props), {}, {
	  ...
	  var getFieldMeta = React.useCallback(function (name, props) {
	    ...
	    return _objectSpread$6(_objectSpread$6({}, props.meta), {}, {
	      value: value,
	  ...
	  var context = _objectSpread$6(_objectSpread$6(_objectSpread$6({}, props), state), {}, {
	...
	var Row = function Row(props) {
	  var componentClasses = classNames$1("wprf-row clearfix wprf-flex", props === null || props === void 0 ? void 0 : props.className);
	  return React.createElement("div", {
	    className: componentClasses
	...
	var Column = function Column(props) {
	  ...
	  var componentClasses = classNames$1("wprf-column", props === null || props === void 0 ? void 0 : props.className, (_classNames = {}, _defineProperty$1(_classNames, "wprf-column-".concat(12 / (props === null || props === void 0 ? void 0 : props.column)), (props === null || props === void 0 ? void 0 : props.column) && props.column !== 12), _defineProperty$1(_classNames, "wprf-column-12", props.column === 12), _classNames));
	  return React.createElement("div", {
	    className: componentClasses
	  }, props === null || props === void 0 ? void 0 : props.children);
	};
	...
	var Label = function Label(props) {
	  ...
	  var componentClasses = classNames$1("wprf-input-label", props === null || props === void 0 ? void 0 : props.className);
	...
	var Image = function Image(props) {
	  ...
	  var componentClasses = classNames$1(["wprf-input-image", props === null || props === void 0 ? void 0 : props.className]);
	...
	var withLabel = function withLabel(WrappedComponent) {
	  var WithLabel = function WithLabel(props) {
	    ...
	    var styleClasses = classNames$1((_classNames = {}, _defineProperty$1(_classNames, "wprf-style-".concat(styles === null || styles === void 0 ? void 0 : styles.type), (styles === null || styles === void 0 ? void 0 : styles.type) || false), _defineProperty$1(_classNames, 'wprf-label-none', label === undefined || label === '' || label.length === 0), _defineProperty$1(_classNames, "wprf-".concat((styles === null || styles === void 0 ? void 0 : (_styles$label = styles.label) === null || _styles$label === void 0 ? void 0 : _styles$label.position) || 'inline', "-label"), ((_styles$label$positio = styles === null || styles === void 0 ? void 0 : (_styles$label2 = styles.label) === null || _styles$label2 === void 0 ? void 0 : _styles$label2.position) !== null && _styles$label$positio !== void 0 ? _styles$label$positio : true) && label != undefined), _classNames));
	    ...
	    var componentClasses = classNames$1("wprf-control-wrapper", "wprf-type-".concat(type), styleClasses, props === null || props === void 0 ? void 0 : props.classes, _defineProperty$1({}, "wprf-name-".concat(name), name));
	    return React.createElement("div", {
	      className: componentClasses
	    }, is_pro == true && React.createElement(Badge, _extends$2({}, badge, {
	      renderLabel: function renderLabel(badge, position) {
	        return React.createElement(ControlLabel, _extends$2({}, validProps, {
	      ...
	      renderComponent: function renderComponent() {
	        ...
	        return React.createElement(ControlField, {
	          ...
	          renderComponent: function renderComponent() {
	            return React.createElement(WrappedComponent, _extends$2({}, validProps, {
	              id: id
	            }));
	          }
	        });
	      }
	    })), (is_pro == false || is_pro == undefined) && React.createElement(React.Fragment, null, label && label.length > 0 && React.createElement(ControlLabel, _extends$2({}, validProps, {
	      context: rest === null || rest === void 0 ? void 0 : rest.context,
	      label: label,
	      id: id
	...
	var Field = function Field(props) {
	  ...
	  switch (props.type) {
	    ...
	    case "number":
	    case "hidden":
	      return React.createElement(Input$4, props);
	    ...
	    case "group":
	      return React.createElement(Group$2, props);
	...
	var DateControl = function DateControl(props) {
	  ...
	  return React.createElement(components$1.Dropdown, {
	    className: "wprf-control-datetime",
	    renderToggle: function renderToggle(_ref) {
	      _ref.isOpen;
	          var onToggle = _ref.onToggle;
	      return React.createElement(components$1.Button, {
	        isTertiary: true,
	        onClick: onToggle
	...
	var Group$1 = function Group(props) {
	  ...
	  var allFields = newFields.map(function (item, index) {
	    ...
	    return React.createElement(GenericField, _extends$2({}, rest, {
	      key: item.name,
	      index: props.index,
	      onChange: handleChange
	    }, item, {
	...
	*/
	...
	var RepeaterField = function RepeaterField(props) {
	  ...
	  }, React.createElement(components$1.Icon, {
	    onClick: function onClick() {
	...
	var ModalContent = function ModalContent(props) {
	  ...
	  React.useEffect(function () {
	    ...
	    var allFields = newFields.map(function (item, index) {
	      var parentIndex = [].concat(_toConsumableArray(props.parentIndex), ['fields', index]);
	      return React.createElement(Field$1, _extends$2({
	        key: item.name
	      }, item, {
	        parentIndex: parentIndex
	      }));
	  ...
	  }, ((_props$body = props.body) === null || _props$body === void 0 ? void 0 : _props$body.footer) && isString(props.body.footer) && React.createElement("p", null, props.body.footer), React.createElement(GenericField, _extends$2({
	    type: "button"
	...
	var RadioCard = function RadioCard(props) {
	  ...
	  var componentClasses = classNames$1(["wprf-control", "wprf-radio-card", "wprf-input-radio-set-wrap", props === null || props === void 0 ? void 0 : props.className]);
	  ...
	  return React.createElement("div", {
	    ...
	    }, label), React.createElement(GenericInput, _extends$2({}, validProps, {
	      is_pro: is_pro,
	      type: "radio",
	      value: value,
	...
	var Section = function Section(props) {
	  ...
	  var componentClasses = classNames$1('wprf-control-section', props === null || props === void 0 ? void 0 : props.classes, props === null || props === void 0 ? void 0 : props.name, {
	...
	var Slider = function Slider(props) {
	  ...
	  }, React.createElement(components$1.RangeControl, {
	  ...
	  return wp.media.view.MediaFrame.Post.extend({
	    ...
	    createStates: function createStates() {
	      ...
	      this.states.add([new wp.media.controller.Library({
	        ...
	        multiple: 'add',
	        editable: false,
	        library: wp.media.query(lodash.defaults({
	          type: 'image'
	...
	const slimImageObject = img => {
	  ...
	  return lodash.pick(img, attrSet);
	};
	...
	class MediaUpload extends React.Component {
	  ...
	  onOpen() {
	    ...
	    if (!this.props.gallery) {
	      ...
	      lodash.castArray(this.props.value).forEach(id => {
	        selection.add(wp.media.attachment(id));
	      });
	    } // load the images so they are available in the media modal.


	    getAttachmentsCollection(lodash.castArray(this.props.value)).more();
	  }
	...
	var Media = function Media(props) {
	  ...
	  }, imageData != null && React.createElement("div", {
	...
	var Editor = function Editor(props) {
	  var _useState = React.useState(require$$1.EditorState.createEmpty()),
	      _useState2 = _slicedToArray(_useState, 2),
	  ...
	  React.useEffect(function () {
	    if (props.value) {
	      ...
	      var contentState = require$$1.ContentState.createFromBlockArray(contentBlocks, entityMap);

	      var _editorState = require$$1.EditorState.createWithContent(contentState);

	      setEditorState(_editorState);
	    }
	  }, []);
	  React.useEffect(function () {
	    var tempValue = draftToHtml(require$$1.convertToRaw(editorState.getCurrentContent()));
	    props.onChange({
	      target: {
	        type: 'editor',
	        value: tempValue,
	...
	var Button = function Button(props) {
	  ...
	  if (props !== null && props !== void 0 && props.href) {
	    return React.createElement("a", {
	      ...
	      className: classNames$1('wprf-control wprf-button wprf-href-btn', props === null || props === void 0 ? void 0 : props.classes)
	  ...
	  return React.createElement(React.Fragment, null, React.createElement("button", _extends$2({}, validProps, {
	    name: props.name,
	    disabled: isLoading,
	    ...
	    className: classNames$1('wprf-control wprf-button wprf-btn', props === null || props === void 0 ? void 0 : props.classes)
	...
	var Message = function Message(props) {
	  ...
	  return React.createElement("div", {
	    className: classNames$1('wprf-control', 'wprf-message', "wprf-".concat(type, "-message"), "wprf-".concat(props.name, "-message"))
	...
	var __importStar$8 = (commonjsGlobal && commonjsGlobal.__importStar) || function (mod) {
	    ...
	    var result = {};
	    if (mod != null) for (var k in mod) if (k !== "default" && Object.hasOwnProperty.call(mod, k)) __createBinding$8(result, mod, k);
	...
	var SuccessIcon = function () { return (react_1$b.default.createElement("div", { style: Object.assign({}, styles$8.icon, styles$8.iconSuccess) },
	    ...
	    react_1$b.default.createElement("span", { style: Object.assign({}, styles$8.iconSuccessLine, styles$8.iconSuccessLineTip) }),
	    react_1$b.default.createElement("span", { style: Object.assign({}, styles$8.iconSuccessLine, styles$8.iconSuccessLineLong) }),
	    react_1$b.default.createElement("div", { style: styles$8.iconSuccessPlaceholder }),
	    react_1$b.default.createElement("div", { style: styles$8.iconSuccessFix }),
	    react_1$b.default.createElement("div", { style: Object.assign({}, styles$8.iconSuccessBeforeAfter, styles$8.iconSuccessAfter) }))); };
	...
	var ErrorIcon = function () { return (react_1$a.default.createElement("div", { style: Object.assign({}, styles$7.icon, styles$7.iconError) },
	    react_1$a.default.createElement("span", { style: styles$7.iconErrorX },
	        react_1$a.default.createElement("span", { style: Object.assign({}, styles$7.iconErrorLine, styles$7.iconErrorLineLeft) }),
	        react_1$a.default.createElement("span", { style: Object.assign({}, styles$7.iconErrorLine, styles$7.iconErrorLineRight) })))); };
	...
	var InfoIcon = function () { return (react_1$9.default.createElement("div", { style: Object.assign({}, styles$6.icon, styles$6.iconInfo) },
	    ...
	    react_1$9.default.createElement("div", { style: styles$6.iconInfoAfter }))); };
	...
	WarningIcon.default = (function () { return (react_1$8.default.createElement("div", { style: Object.assign({}, styles$5.icon, styles$5.iconWarning) },
	    ...
	    react_1$8.default.createElement("span", { style: styles$5.iconWarningDot }))); });
	...
	var Buttons = /** @class */ (function (_super) {
	    ...
	    Buttons.prototype.confirmButtonRender = function () {
	        ...
	        var confirmButtonStyle = Object.assign({}, styles$3.button, this.getButtonStyle(confirmBtnBsStyle), this.props.confirmBtnStyle || {});
	        /**
	         ...
	         */
	        return (react_1$6.default.createElement("a", { ref: this.setConfirmButtonElementRef, href: '#', style: confirmButtonStyle, className: "btn btn-" + this.props.btnSize + " btn-" + confirmBtnBsStyle + " " + this.props.confirmBtnCssClass + " " + (this.props.disabled ? 'disabled' : ''), onClick: function (e) {
	                e.stopPropagation();
	                e.preventDefault();
	    ...
	    Buttons.prototype.cancelButtonRender = function () {
	        ...
	        var cancelButtonStyle = Object.assign({}, styles$3.button, this.props.cancelBtnStyle || {});
	        /**
	         * These buttons are <a> anchor tags because for some reason React is triggering click events on <button>
	         * elements when an enter key event is fired from an input field in the alert.
	         * Please do not change this back to any other type of element.
	         */
	        return (react_1$6.default.createElement("a", { ref: this.setCancelButtonElementRef, href: '#', style: cancelButtonStyle, className: "btn btn-" + this.props.btnSize + " btn-" + cancelBtnBsStyle + " " + this.props.cancelBtnCssClass, onClick: function (e) {
	                e.stopPropagation();
	                e.preventDefault();
	    ...
	    Buttons.prototype.render = function () {
	        ...
	        return (react_1$6.default.createElement("p", { style: SweetAlertStyles_1$3.actions }, this.props.customButtons ? (this.props.customButtons) : (react_1$6.default.createElement(react_1$6.default.Fragment, null, !this.props.reverseButtons ? (react_1$6.default.createElement(react_1$6.default.Fragment, null,
	            this.cancelButtonRender(),
	            this.confirmButtonRender())) : (react_1$6.default.createElement(react_1$6.default.Fragment, null,
	...
	var Input = /** @class */ (function (_super) {
	    ...
	    Input.prototype.render = function () {
	        var _this = this;
	        return (react_1$5.default.createElement("div", { style: { position: 'relative' } },
	            this.props.inputType === 'textarea' ? (react_1$5.default.createElement("textarea", { ref: this.setInputElementRef, rows: 4, className: "form-control", value: this.props.inputValue || '', onChange: function (e) { return _this.props.onChangeInput(e); }, onKeyDown: function (e) { return _this.props.onInputKeyDown(e); }, placeholder: this.props.placeholder })) : (react_1$5.default.createElement("input", { type: this.props.inputType, ref: this.setInputElementRef, className: "form-control", value: this.props.inputValue || '', onChange: function (e) { return _this.props.onChangeInput(e); }, onKeyDown: function (e) { return _this.props.onInputKeyDown(e); }, placeholder: this.props.placeholder })),
	            this.props.showValidationMessage && (react_1$5.default.createElement("div", { style: styles$2.inputErrorIcon },
	                react_1$5.default.createElement("div", { style: Object.assign({}, styles$2.inputErrorIconBeforeAfter, styles$2.inputErrorIconBefore) }),
	                react_1$5.default.createElement("div", { style: Object.assign({}, styles$2.inputErrorIconBeforeAfter, styles$2.inputErrorIconAfter) })))));
	    };
	    return Input;
	...
	var ValidationMessage = function (_a) {
	    ...
	    return (react_1$4.default.createElement("div", { style: styles$1.validationMessage },
	        react_1$4.default.createElement("div", { style: styles$1.exclamationIcon }, "!"),
	        message));
	};
	...
	var Title = function (_a) {
	    ...
	    return react_1$3.default.createElement("h2", { style: SweetAlertStyles_1$2.title }, children);
	};
	...
	var Content$1 = function (_a) {
	    var children = _a.children;
	    return (react_1$2.default.createElement("div", { style: SweetAlertStyles_1$1.contentContainer }, children));
	};
	...
	var Overlay = /** @class */ (function (_super) {
	    ...
	    Overlay.prototype.render = function () {
	        ...
	        return show ? (react_1$1.default.createElement("div", { ref: this.setOverlayElementRef, style: __assign$1(__assign$1({}, SweetAlertStyles_1.overlay), SweetAlertStyles_1.sweetAlertContainer), onClick: function (e) { return onClick(e); }, tabIndex: 0, onKeyDown: function (e) { return onKeyDown(e); } }, children)) : (react_1$1.default.createElement("div", { style: SweetAlertStyles_1.sweetAlertContainer, tabIndex: 0, onKeyDown: function (e) { return onKeyDown(e); } }, children));
	    };
	    return Overlay;
	...
	patterns.emailRegex = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
	...
	propTypes.SWEET_ALERT_PROP_TYPES = {
	    type: prop_types_1$1.default.oneOf(["default", "info", "success", "warning", "danger", "error", "input", "custom", "controlled"]),
	    ...
	    title: prop_types_1$1.default.oneOfType([prop_types_1$1.default.node, prop_types_1$1.default.string]).isRequired,
	    onCancel: prop_types_1$1.default.func,
	    onConfirm: prop_types_1$1.default.func.isRequired,
	    confirmBtnText: prop_types_1$1.default.oneOfType([prop_types_1$1.default.node, prop_types_1$1.default.string]),
	    ...
	    cancelBtnText: prop_types_1$1.default.oneOfType([prop_types_1$1.default.node, prop_types_1$1.default.string]),
	    ...
	    customIcon: prop_types_1$1.default.oneOfType([prop_types_1$1.default.node, prop_types_1$1.default.string]),
	    ...
	    defaultValue: prop_types_1$1.default.oneOfType([prop_types_1$1.default.number, prop_types_1$1.default.string]),
	...
	var Modal = function Modal(props) {
	  ...
	  }, React.createElement(GenericField, _extends$2({
	    type: "button"
	  }, props === null || props === void 0 ? void 0 : props.button, {
	    onClick: openModal
	  })), isOpen && React.createElement(_default, {
	  ...
	  }, React.createElement(ModalContent, _extends$2({}, props, {
	    isLoading: isLoading,
	...
	var AdvancedTemplate = function AdvancedTemplate(props) {
	  ...
	  var handleBeforeInput = function handleBeforeInput(chars, editorState, eventTimeStamp) {
	    var raw = require$$1.convertToRaw(editorState.getCurrentContent());
	  ...
	  var clicked = function clicked(value) {
	    ...
	    var nextEditorState = require$$1.EditorState.createEmpty();

	    if (sectionState.isCollapsed()) {
	      nextContentState = require$$1.Modifier.insertText(contentState, sectionState, "{{".concat(value, "}}"));
	    } else {
	      nextContentState = require$$1.Modifier.replaceText(contentState, sectionState, "{{".concat(value, "}}"));
	    }

	    nextEditorState = require$$1.EditorState.push(editorState, nextContentState, 'insert-fragment');
	  ...
	  React.useEffect(function () {
	    ...
	    if (!((_builderContext$saved = builderContext.savedValues) !== null && _builderContext$saved !== void 0 && _builderContext$saved['advanced_template'])) {
	      ...
	      var _editorState2 = require$$1.EditorState.createWithContent(contentState);
	...
	var Submit = function Submit(_ref) {
	  ...
	  }, React.createElement(components$1.Button, {
	...
	var Content = function Content(_ref) {
	  ...
	  return React.createElement("div", {
	    ...
	    var componentClasses = classNames$1("wprf-tab-content", "wprf-tab-".concat(tab === null || tab === void 0 ? void 0 : tab.id), {
	  ...
	  })), applyFilters('wprf_tab_content', '', rest)), (config === null || config === void 0 ? void 0 : (_config$step = config.step) === null || _config$step === void 0 ? void 0 : _config$step.show) && React.createElement(SteppedButton$1, {
	    tabs: tabsFields,
	...
	var Tab = function Tab(props) {
	  ...
	  return React.createElement(React.Fragment, null, React.createElement(Menu$1, {
	    active: activeTab,
	    ...
	    config: props.config,
	    context: builderContext
	  }), React.createElement(Content, _extends$2({}, props, {
	    tabs: builderContext.tabs,
	    active: activeTab,
	...
	var FormBuilder = function FormBuilder(props) {
	  ...
	  var componentClasses = classNames$1("wp-react-form wprf-tabs-wrapper", props === null || props === void 0 ? void 0 : props.className, {
