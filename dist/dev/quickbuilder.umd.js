(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('classnames'), require('@wordpress/data'), require('lodash-es'), require('@wordpress/api-fetch'), require('@wordpress/date'), require('moment'), require('intersect'), require('@wordpress/i18n'), require('lodash'), require('@wordpress/hooks'), require('sweetalert2'), require('@wordpress/components'), require('copy-to-clipboard'), require('react-select'), require('react-dom'), require('@wordpress/media-utils'), require('react-draft-wysiwyg'), require('draft-js'), require('draftjs-to-html'), require('html-to-draftjs'), require('react-bootstrap-sweetalert')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'classnames', '@wordpress/data', 'lodash-es', '@wordpress/api-fetch', '@wordpress/date', 'moment', 'intersect', '@wordpress/i18n', 'lodash', '@wordpress/hooks', 'sweetalert2', '@wordpress/components', 'copy-to-clipboard', 'react-select', 'react-dom', '@wordpress/media-utils', 'react-draft-wysiwyg', 'draft-js', 'draftjs-to-html', 'html-to-draftjs', 'react-bootstrap-sweetalert'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.quickbuilder = {}, global.React, global.classNames, global.wpData, global.lodashEs, global.wpApiFetch, global.wpDate, global.momentLib, global.intersect, global.wpI18n, global.lodash, global.wpHooks, global.sweetalert2, global.wpComponents, global.copy, global.reactSelect, global.ReactDOM, global.wpMedia, global.reactDraftWysiwyg, global.draftJs, global.draftjsToHtml, global.htmlToDraftjs, global.sweetalert));
})(this, (function (exports, React, classNames$1, data, lodashEs, apiFetch, date, moment, intersect, i18n, lodash, hooks, Swal, components$1, copy$1, ReactSelect, reactDom, mediaUtils, reactDraftWysiwyg, draftJs, draftToHtml, htmlToDraft, SweetAlert$1) { 'use strict';
  ...
  var withLabel = function withLabel(WrappedComponent) {
    var WithLabel = function WithLabel(props) {
      ...
      if (type === "hidden") {
        return React.createElement(WrappedComponent, _extends$3({}, props, {
          id: id
        }));
      }
      ...
      return React.createElement("div", {
        className: componentClasses
      }, is_pro == true && React.createElement(React.Fragment, null, React.createElement(Badge, _extends$3({}, badge, rest, {
        renderLabel: function renderLabel(badge, position) {
          return React.createElement(ControlLabel, _extends$3({}, validProps, {
        ...
        renderComponent: function renderComponent() {
          ...
          return React.createElement(ControlField, {
            ...
            renderComponent: function renderComponent() {
              return React.createElement(WrappedComponent, _extends$3({}, validProps, {
                disable: true,
                id: id
              }));
            }
      ...
      })))), (is_pro == false || is_pro == undefined) && React.createElement(React.Fragment, null, label && label.length > 0 && React.createElement(ControlLabel, _extends$3({}, validProps, {
        context: rest === null || rest === void 0 ? void 0 : rest.context,
        label: label,
        id: id
  ...
  var Field = function Field(props) {
    ...
    switch (props.type) {
      ...
      case "number":
      case "hidden":
        return React.createElement(Input$2, props);
      case "textarea":
  ...
  var DateControl = function DateControl(props) {
    ...
    return React.createElement(components$1.Dropdown, {
      ...
      renderContent: function renderContent() {
        return React.createElement(components$1.DateTimePicker
        // @ts-ignore
        , {
  ...
  var CodeViewer = function CodeViewer(props) {
    ...
    }, /*#__PURE__*/React__default["default"].createElement("textarea", _objectSpread$4(_objectSpread$4({}, validProps), extraProps)), React.createElement(components$1.Button, {
  ...
  var Group$1 = function Group(props) {
    ...
    var allFields = newFields.map(function (item, index) {
      ...
      return React.createElement(GenericField, _extends$3({}, rest, {
        key: item.name,
        index: props.index,
        onChange: handleChange
      }, item, {
  ...
  var RepeaterField = function RepeaterField(props) {
    ...
    return React.createElement("div", {
    ...
    }, React.createElement("h4", null, React.createElement(components$1.Icon, {
      icon: "move"
      ...
      return React.createElement(GenericField, _extends$3({
  ...
  var ModalContent = function ModalContent(props) {
    ...
    React.useEffect(function () {
      ...
      var allFields = newFields.map(function (item, index) {
        var parentIndex = [].concat(_toConsumableArray$1(props.parentIndex), ['fields', index]);
        return React.createElement(Field$1, _extends$3({
          key: item.name
        }, item, {
          parentIndex: parentIndex
        }));
    ...
    }, ((_props$body = props.body) === null || _props$body === void 0 ? void 0 : _props$body.footer) && isString(props.body.footer) && React.createElement("p", null, props.body.footer), React.createElement(GenericField, _extends$3({
      type: "button"
  ...
  var RadioCard = function RadioCard(props) {
    ...
    return React.createElement("div", {
      ...
      }, label), React.createElement(GenericInput, _extends$3({}, rest, validProps, {
        is_pro: is_pro,
        type: "radio",
        value: value,
...
Please read the updated README.md at https://github.com/SortableJS/react-sortablejs.
  ...
  */
  ...
  var Button = function Button(props) {
    ...
    return React.createElement(React.Fragment, null, React.createElement("button", _extends$3({}, validProps, {
      name: props.name,
      disabled: isLoading,
  ...
  var Modal = function Modal(props) {
    ...
    }, React.createElement(GenericField, _extends$3({
      type: "button"
    ...
    }, React.createElement(ModalContent, _extends$3({}, props, {
      isLoading: isLoading,
  ...
  var Tab = function Tab(props) {
    ...
    return React.createElement(React.Fragment, null, React.createElement(Menu$1, {
      ...
      config: props.config,
      context: builderContext
    }), React.createElement(Content, _extends$3({}, props, {
      tabs: builderContext.tabs,
      active: activeTab,
