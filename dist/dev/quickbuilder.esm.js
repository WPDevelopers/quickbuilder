...
function GenericCheckbox(props) {
  ...
  return createElement("div", {
    className: componentClasses
  }, createElement(GenericInput, _objectSpread$a(_objectSpread$a({}, props), {}, {
    type: 'checkbox'
  })), createElement("label", {
    htmlFor: props.id
  }, props.label));
...
function Checkbox(props) {
  ...
  if (multiple) {
    ...
    return createElement("div", {
      ...
      }, createElement(GenericCheckbox, _objectSpread$a(_objectSpread$a({}, item), {}, {
  ...
  return createElement(GenericInput, _objectSpread$a(_objectSpread$a({}, props), {}, {
    type: 'checkbox'
  }));
}
...
var SteppedButton = function SteppedButton(props) {
  ...
  return createElement("div", {
    ...
    }, (_props$config$buttons = props.config.buttons) === null || _props$config$buttons === void 0 ? void 0 : _props$config$buttons[button]), nextTab == undefined && ((_props$config$buttons2 = props.config.buttons) === null || _props$config$buttons2 === void 0 || (_props$config$buttons2 = _props$config$buttons2[button]) === null || _props$config$buttons2 === void 0 ? void 0 : _props$config$buttons2.type) && createElement(Field$1, (_props$config$buttons3 = props.config.buttons) === null || _props$config$buttons3 === void 0 ? void 0 : _props$config$buttons3[button]));
  }));
};
...
var Content = function Content(_ref) {
  ...
  })), applyFilters('wprf_tab_content', '', rest)), (rest === null || rest === void 0 || (_rest$step = rest.step) === null || _rest$step === void 0 ? void 0 : _rest$step.show) && createElement(SteppedButton$1, {
    fields: tabsFields,
    active: active,
    setActive: setActive,
