(function (global, factory) {
  ...
  var SweetAlert = function SweetAlert() {
    ...
    return Swal__default["default"].fire(_objectSpread$8({
  ...
  var Message = function Message(props) {
    ...
    return React.createElement("div", {
      className: classNames__default["default"]('wprf-control', 'wprf-message', "wprf-".concat(type, "-message"), "wprf-".concat(props.name, "-message"))
