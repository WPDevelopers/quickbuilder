(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@wordpress/data'), require('lodash-es'), require('@wordpress/api-fetch'), require('@wordpress/date'), require('moment'), require('@wordpress/i18n'), require('lodash'), require('@wordpress/hooks'), require('@wordpress/components'), require('@wordpress/media-utils'), require('react-draft-wysiwyg'), require('draft-js'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', '@wordpress/data', 'lodash-es', '@wordpress/api-fetch', '@wordpress/date', 'moment', '@wordpress/i18n', 'lodash', '@wordpress/hooks', '@wordpress/components', '@wordpress/media-utils', 'react-draft-wysiwyg', 'draft-js', 'react-dom'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.quickbuilder = {}, global.React, global.wpData, global.lodashEs, global.wpApiFetch, global.wpDate, global.momentLib, global.wpI18n, global.lodash, global.wpHooks, global.wpComponents, global.wpMedia, global.reactDraftWysiwyg, global.draftJs, global.ReactDOM));
})(this, (function (exports, React, data, lodashEs, apiFetch, date, moment, i18n, lodash, hooks, components$1, mediaUtils, reactDraftWysiwyg, require$$1, reactDom) { 'use strict';
	...
	*/
	...
	var ColorPicker = function ColorPicker(props) {
	  ...
	  }, i18n.__('Reset', 'notificationx')), React.createElement(components$1.ColorPicker, {
	    color: value,
