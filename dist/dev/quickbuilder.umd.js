(function (global, factory) {
  ...
  var Menu = function Menu(props) {
    ...
    return React.createElement("div", {
      ...
      return React.createElement("li", {
        className: classNames__default["default"]("wprf-tab-nav-item", (_classNames = {}, _defineProperty$1(_classNames, "".concat(tab.classes), tab.classes), _defineProperty$1(_classNames, "wprf-active-nav", active === tab.id), _defineProperty$1(_classNames, "wprf-tab-complete", config !== null && config !== void 0 && config.completionTrack ? index <= currentTabIndex : false), _classNames)),
        "data-key": tab.id,
        key: tab.id,
  ...
  var Column = function Column(props) {
    ...
    var componentClasses = classNames__default["default"]("wprf-column", props === null || props === void 0 ? void 0 : props.className, (_classNames = {}, _defineProperty$1(_classNames, "wprf-column-".concat(12 / (props === null || props === void 0 ? void 0 : props.column)), (props === null || props === void 0 ? void 0 : props.column) && props.column !== 12), _defineProperty$1(_classNames, "wprf-column-12", props.column === 12), _classNames));
    return React.createElement("div", {
      className: componentClasses
    }, props === null || props === void 0 ? void 0 : props.children);
  };
  ...
  var withLabel = function withLabel(WrappedComponent) {
    var WithLabel = function WithLabel(props) {
      ...
      var styleClasses = classNames__default["default"]((_classNames = {}, _defineProperty$1(_classNames, "wprf-style-".concat(styles === null || styles === void 0 ? void 0 : styles.type), (styles === null || styles === void 0 ? void 0 : styles.type) || false), _defineProperty$1(_classNames, "wprf-label-none", label === undefined || label === "" || label.length === 0), _defineProperty$1(_classNames, "wprf-".concat((styles === null || styles === void 0 ? void 0 : (_styles$label = styles.label) === null || _styles$label === void 0 ? void 0 : _styles$label.position) || "inline", "-label"), ((_styles$label$positio = styles === null || styles === void 0 ? void 0 : (_styles$label2 = styles.label) === null || _styles$label2 === void 0 ? void 0 : _styles$label2.position) !== null && _styles$label$positio !== void 0 ? _styles$label$positio : true) && label != undefined), _classNames));
      ...
      var componentClasses = classNames__default["default"]("wprf-control-wrapper", "wprf-type-".concat(type), styleClasses, props === null || props === void 0 ? void 0 : props.classes, _defineProperty$1({}, "wprf-name-".concat(name), name));
      return React.createElement("div", {
        className: componentClasses
      }, is_pro == true && React.createElement(React.Fragment, null, React.createElement(Badge, _extends$2({}, badge, rest, {
  ...
  var RepeaterField = function RepeaterField(props) {
    ...
    return React.createElement("div", {
      ...
      icon: "sort"
    }), React.createElement("h4", null, "\xA0", "\xA0", "#ID: ", props.index), React.createElement("div", {
  ...
  var RadioCard = function RadioCard(props) {
    ...
    return React.createElement("div", {
      ...
      }, label), React.createElement(GenericInput, _extends$2({}, rest, validProps, {
        is_pro: is_pro,
        type: "radio",
        value: value,
...
Please read the updated README.md at https://github.com/SortableJS/react-sortablejs.
  ...
  var Repeater = function Repeater(props) {
    ...
    }, React.createElement(dist.exports.ReactSortable, {
