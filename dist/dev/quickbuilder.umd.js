(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('classnames'), require('@wordpress/data'), require('lodash-es'), require('@wordpress/api-fetch'), require('@wordpress/date'), require('moment'), require('intersect'), require('@wordpress/i18n'), require('lodash'), require('@wordpress/hooks'), require('sweetalert2'), require('@wordpress/components'), require('copy-to-clipboard'), require('react-select'), require('sortablejs'), require('@wordpress/media-utils'), require('react-draft-wysiwyg'), require('draft-js'), require('draftjs-to-html'), require('html-to-draftjs'), require('react-bootstrap-sweetalert')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'classnames', '@wordpress/data', 'lodash-es', '@wordpress/api-fetch', '@wordpress/date', 'moment', 'intersect', '@wordpress/i18n', 'lodash', '@wordpress/hooks', 'sweetalert2', '@wordpress/components', 'copy-to-clipboard', 'react-select', 'sortablejs', '@wordpress/media-utils', 'react-draft-wysiwyg', 'draft-js', 'draftjs-to-html', 'html-to-draftjs', 'react-bootstrap-sweetalert'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.quickbuilder = {}, global.React, global.classNames, global.wpData, global.lodashEs, global.wpApiFetch, global.wpDate, global.momentLib, global.intersect, global.wpI18n, global.lodash, global.wpHooks, global.sweetalert2, global.wpComponents, global.copy, global.reactSelect, global.require$$0, global.wpMedia, global.reactDraftWysiwyg, global.draftJs, global.draftjsToHtml, global.htmlToDraftjs, global.sweetalert));
})(this, (function (exports, React, classNames, data, lodashEs, apiFetch, date, moment, intersect, i18n, lodash, hooks, Swal, components, copy, ReactSelect, require$$0, mediaUtils, reactDraftWysiwyg, draftJs, draftToHtml, htmlToDraft, SweetAlert$1) { 'use strict';
